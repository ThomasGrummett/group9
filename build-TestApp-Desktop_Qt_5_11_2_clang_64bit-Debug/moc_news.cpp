...
QT_MOC_LITERAL(1, 5, 6), // "reload"
QT_MOC_LITERAL(2, 12, 0), // ""
QT_MOC_LITERAL(3, 13, 9) // "on_reload"

    },
    "news\0reload\0\0on_reload"
};
...
void news::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (news::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&news::reload)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject news::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_news.data,
      qt_meta_data_news,  qt_static_metacall, nullptr, nullptr}
};
